    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Add a new expense category</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" class="w-full rounded-lg border-gray-300 text-sm focus:border-slate-500 focus:ring-slate-500" placeholder="Optional description...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-rose-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_amount" id="max_amount" value="{{ old('max_amount') }}" min="0" step="1000" 
                    ...
                    <div>
                        <label class="flex items-center gap-3">
                            <input type="checkbox" name="requires_receipt" value="1" {{ old('requires_receipt', true) ? 'checked' : '' }} class="rounded border-gray-300 text-slate-600 focus:ring-slate-500">
